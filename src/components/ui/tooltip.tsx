...
/**
 * Overrides the `<body>` portal target. A `showModal()` dialog sits in the
 * browser's top layer, which paints above everything else regardless of
 * z-index — so a tooltip raised inside one must be portalled into the dialog
 * or it opens beneath the backdrop, invisible.
 */
...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal container={container ?? undefined}>
      ...
      >
        {/* `data-instant` marks a tooltip opening inside a warm delay group —
            sweeping across adjacent triggers should not replay the zoom. */}
