...
const call = () =>
  GET(new Request("http://localhost:3000/api/drivers/d1/affected"), {
...
describe("GET /api/drivers/[id]/affected", () => {
  ...
  it("asks affectedTrips for this driver, with the server's own today", async () => {
